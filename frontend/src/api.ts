...
export type User={id:string;name:string;email:string;phone?:string|null;jobTitle?:string|null;avatarUrl?:string|null;role:Role;organizationId:string;organizationName:string};
