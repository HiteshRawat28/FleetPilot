...
async function main() {
    ...
    const organization = await db.organization.create({
        data: {
            name: "TransitOps India Pvt. Ltd.",
            slug: "transitops-india",
            operationsEmail: "operations@transitops.in",
        },
    });
    ...
    await db.trip.createMany({
        data: [
            ...
            },
            {
                ...
                cargoWeightKg: 350,
                plannedDistanceKm: 112,
                revenue: 18000,
                status: client_1.TripStatus.COMPLETED,
                vehicleId: van.id,
                driverId: alex.id,
                finalOdometerKm: 74000,
                fuelConsumedL: 42,
    ...
    await db.maintenance.create({
        data: {
            ...
            cost: 8500,
            status: client_1.MaintenanceStatus.ACTIVE,
        },
    });
    ...
    await db.expense.create({
        data: {
            organizationId,
            vehicleId: truck.id,
            type: client_1.ExpenseType.TOLL,
            description: "Expressway toll",
            amount: 3200,
        },
    });
    console.log("Seed complete. Owner: owner@transitops.in / Password@123");
    console.log("Verified driver: driver@transitops.in / Password@123");
}
